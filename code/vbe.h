...
typedef struct{
	...
	uint8_t Capabilities[4]; //Capabilitites of Graphics controller
	phys_bytes VideoModePtr; //Pointer to VideoModeList
	uint16_t TotalMemory; //Number of 64kb memory bocks
	...
	uint8_t Reserved[221]; //Reserved for VBE implementation scratch

	//Area
	uint8_t OemData[255]; //Data Area for OEM Strings
